...
public class Restaurant
{
    ...
    public string Adresse { get; set; } // Adresse complète du restaurant
    ...
    [MaxLength(500)]
    public string Description { get; set; } // Brève description du restaurant

    public string ImageUrl { get; set; } // URL de l’image principale du restaurant
}
